...
// }
getAll(): Observable<Help[]> {
  return <any>this.http.get("http://localhost:4000/api/getUser/").pipe(map((Response: any) => Response));
}
...
// }
addUsers(users: any) {
  this.http.post("http://localhost:4000/api/SaveUser/", users).subscribe();
}
...
addItems(items: any) {
    ...
    this.http.post("http://localhost:4000/api/postData/", items).subscribe();
}
addOrders(order: any) {
    console.log(order)
...
updateUserData(data:any) {
  console.log("service data to update="+JSON.stringify(data))
  this.http.post("http://localhost:4000/api/UpdateUserVerification", data).subscribe();
    // this.http.put(("/api/UpdateUserVerification" + data.id), data).subscribe();
}
...
updateUsers(data:any) {
  console.log("service data to update="+JSON.stringify(data))
    // this.http.put(("http://localhost:3000/users/" + data.id), data).subscribe();
    this.http.post("http://localhost:4000/api/UpdateUserData", data).subscribe();
}

getItems() :Observable<Items[]> {
    // return <any>this.http.get("http://localhost:3000/myItems").pipe(map((Response: any) => Response));
    return <any>this.http.get("http://localhost:4000/api/getItems/").pipe(map((Response: any) => Response));
...
myItems() :Observable<myCart[]> {
    ...
    return <any>this.http.get("http://localhost:4000/api/getMyItems/").pipe(map((Response: any) => Response));
...
addToCart(items: myCart) {
    ...
    this.http.post("http://localhost:4000/api/addToCart/", items).subscribe();
}
placeOrders(items: Orders) {
    ...
    this.http.post("http://localhost:4000/api/placeOrders/", items).subscribe();
}
...
getAllOrders() :Observable<Orders[]> {
    // return <any>this.http.get("http://localhost:3000/myOrders").pipe(map((Response: any) => Response));
    return <any>this.http.get("http://localhost:4000/api/getAllOrders/").pipe(map((Response: any) => Response));

}
getReviews() :Observable<Reviews[]> {
  // return <any>this.http.get("http://localhost:3000/productReviews").pipe(map((Response: any) => Response));
  return <any>this.http.get("http://localhost:4000/api/getAllReviews/").pipe(map((Response: any) => Response));
...
addReviews(items: Reviews) {
  ...
  this.http.post("http://localhost:4000/api/addReviews/", items).subscribe();
}
...
updateReviews(items: Reviews) {
  ...
  this.http.post("http://localhost:4000/api/updateReviews/", items).subscribe();
}
...
deleteProductFromMyList(items){
// this.http.delete("http://localhost:3000/myItems/"+id).subscribe();
this.http.post("http://localhost:4000/api/deleteProductFromMyList/", items).subscribe();
}
removeProduct(_id) {
    console.log("from service"+JSON.stringify(_id))
  //  this.http.delete("http://localhost:3000/myCart/" + id1).subscribe();
  this.http.post("http://localhost:4000/api/removeProductFromCart/", _id).subscribe();
}
cancelOrder(_id) {
  console.log("from service"+JSON.stringify(_id))
//  this.http.delete("http://localhost:3000/myOrders/" + id1).subscribe();
this.http.post("http://localhost:4000/api/cancelOrder/", _id).subscribe();
}

updateOrderStatus(data:any) {
    // this.http.put(("http://localhost:3000/myOrders/" + data.id), data).subscribe();
    this.http.post("http://localhost:4000/api/updateOrderStatus/", data).subscribe();
}
getMyOrders() :Observable<Orders[]> {
    // return <any>this.http.get("http://localhost:3000/myOrders").pipe(map((Response: any) => Response));
    return <any>this.http.get("http://localhost:4000/api/getMyOrders/").pipe(map((Response: any) => Response));
